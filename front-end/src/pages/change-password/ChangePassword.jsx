            ...
            <div className="container">
                <div className="w-[100%] h-[100vh] flex items-center justify-center">
                    <div className="w-[550px] rounded-lg bg-[#ffffff] shadow-xl p-5 pt-5 pb-6">
                        ...
                        <div className="">
                            <input id="search" type="password" placeholder="Enter your E-mail address" className="w-[100%] p-3 outline-none border-[3px] border-[#d1d1d1] rounded-lg font-normal text-[17px]" />
                        </div>
                        ...
                        <div className="flex justify-end items-center mt-7">
                            <div className="">
                                ...
                                <a href="#" className="bg-[#D82E38] text-[16px] font-semibold ml-3 text-[#ffffff] rounded-md py-3 px-4 active:bg-[#ff6e78]">Change password</a>
                            </div>
                        </div>
                    </div>
                </div>
