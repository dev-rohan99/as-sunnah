...
export const changePassword = (data, navigate) => async (dispatch) => {
    ...
    try{
        await axios.post("http://localhost:8080/api/v1/user/password-reset", {
            id : data.id,
            code : data.code,
...
export const accessLoggedInUser = (token) => async (dispatch) => {
    ...
    try{
        ...
        await axios.get("http://localhost:8080/api/v1/user/me", {
            headers : {
...
export const friendRequstSenderAction = (requesterId, receiverId) => async (dispatch) => {
    ...
    try{
        ...
        await axios.get(`http://localhost:8080/api/v1/user/add-friend/${requesterId}/${receiverId}`).then((res) => {
...
export const confirmFriendRequstAction = (receiverId, requesterId) => async (dispatch) => {
    ...
    try{
        ...
        await axios.get(`http://localhost:8080/api/v1/user/confirm-friend-request/${receiverId}/${requesterId}`).then((res) => {
...
export const cancelFriendRequstAction = (requesterId, receiverId) => async (dispatch) => {
    ...
    try{
        ...
        await axios.get(`http://localhost:8080/api/v1/user/cancel-friend-request/${requesterId}/${receiverId}`).then((res) => {
