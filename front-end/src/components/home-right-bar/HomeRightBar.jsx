  ...
  return (
    ...
    <div className="rightListBar z-10 sticky top-0 w-[320px] h-[100vh] overflow-hidden overflow-y-scroll">
        ...
        <ul className="mt-2 pb-2 mb-3 border-b-[3px] border-[#d1d1d1]">
            <li><a className="flex p-2 items-center justify-start hover:bg-[#E4E6E8] rounded-l-md mb-3" href="/"><img alt='' src={logo} className="h-[30px] rounded-full w-[30px] object-cover"/> <h6 className="font-semibold ml-3 text-[#383838] text-[16px]">Ashraful Haque</h6></a></li>
        </ul>

        <h5 className="font-bold text-[#383838]">Group Conversations</h5>

        <ul className="mt-2 mb-3">
            <li><a className="flex p-2 items-center justify-start hover:bg-[#E4E6E8] rounded-l-md mb-3" href="/"><img alt='' src={logo} className="h-[30px] rounded-full w-[30px] object-cover"/> <h6 className="font-semibold ml-3 text-[#383838] text-[16px]">Developers</h6></a></li>
        </ul>
